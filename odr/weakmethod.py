...
class WeakBoundMethod:
    ...
    print_num method:
        ...
        >>> wmeth
        <WeakBoundMethod wrapping <...Example...> and <function Example.print_num...>>
    ...
    def __repr__(self):
        return "<{} wrapping {!r} and {!r}>".format(
            self.__class__.__name__, self._weak_instance(), self._free_method
        )
